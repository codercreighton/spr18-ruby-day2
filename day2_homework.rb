...
# # clears the screen before game
# system('clear')
# #Tracks computer score and user score
# system('clear')
# comp_score = 0 
# user_score = 0
# puts "Let's see who can win the best out of 5 games (tie games do not count):"
...
# 	puts "Computer wins best out of 5 decisive games with a score of #{comp_score}."
# else
# 	puts "User wins best out of 5 decisive games with a score of #{user_score}."
# end		
...
# puts "Your final score is #{score} out of #{cos_n_caps.length} questions."